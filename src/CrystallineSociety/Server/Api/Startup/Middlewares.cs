...
namespace CrystallineSociety.Server.Api.Startup;
...
public class Middlewares
{
    public static void Use(IApplicationBuilder app, IHostEnvironment env, IConfiguration configuration)
    {
        ...
        app.UseCors(options => options.WithOrigins("https://localhost:8201", "https://0.0.0.0").AllowAnyHeader().AllowAnyMethod().AllowCredentials());
