...
using CrystallineSociety.Server.Components;
...
public class Middlewares
{
    ...
    public static void Use(WebApplication app, IHostEnvironment env, IConfiguration configuration)
    {
        ...
        var blazorApp = app.MapRazorComponents<App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("CrystallineSociety") is true).Except([Assembly.GetExecutingAssembly()]).ToArray());
