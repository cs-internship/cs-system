        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BadgeSystemUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    DocumentUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    DocumentSyncInfo_SyncId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DocumentSyncInfo_SyncStartDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DocumentSyncInfo_SyncEndDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DocumentSyncInfo_SyncHash = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    DocumentSyncInfo_SyncStatus = table.Column<int>(type: "int", nullable: true),
                    DocumentSyncInfo_LastSyncDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DocumentSyncInfo_LastSyncOffset = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    BadgeSyncInfo_SyncId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BadgeSyncInfo_SyncStartDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    BadgeSyncInfo_SyncEndDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    BadgeSyncInfo_SyncHash = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    BadgeSyncInfo_SyncStatus = table.Column<int>(type: "int", nullable: true),
                    BadgeSyncInfo_LastSyncDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    BadgeSyncInfo_LastSyncOffset = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrystaProgram", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceHtmlUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    SourceContentUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CrystaUrl = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    ...
                    LastHash = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    SyncInfo_SyncId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SyncInfo_SyncStartDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    SyncInfo_SyncEndDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    SyncInfo_SyncHash = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SyncInfo_SyncStatus = table.Column<int>(type: "int", nullable: true),
                    SyncInfo_LastSyncDateTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    SyncInfo_LastSyncOffset = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CrystaProgramId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FileExtension = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    FileNameWithoutExtension = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Document_CrystaProgram_CrystaProgramId",
                        column: x => x.CrystaProgramId,
                        principalSchema: "dbo",
                        principalTable: "CrystaProgram",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PushNotificationSubscriptions_UserSession_UserSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Document_CrystaProgramId",
                schema: "dbo",
                table: "Document",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleClaim_RoleId_ClaimType",
                schema: "dbo",
                table: "RoleClaim",
