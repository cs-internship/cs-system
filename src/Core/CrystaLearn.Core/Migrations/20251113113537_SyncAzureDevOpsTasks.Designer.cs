...
namespace CrystaLearn.Core.Migrations
{
    ...
    [Migration("20251113113537_SyncAzureDevOpsTasks")]
    partial class SyncAzureDevOpsTasks
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("CrystaLearn.Core.Models.Crysta.SyncInfo", "BadgeSyncInfo", b1 =>
                        {
                            ...
                            b1.ToTable("CrystaPrograms", "CrystaLearn");
            ...
            modelBuilder.Entity("CrystaLearn.Core.Models.Crysta.CrystaTask", b =>
                {
                    ...
                    b.HasOne("CrystaLearn.Core.Models.Identity.User", "CreatedByUser")
                        .WithMany()
