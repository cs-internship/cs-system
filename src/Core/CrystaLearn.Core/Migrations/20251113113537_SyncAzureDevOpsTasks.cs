    ...
    public partial class SyncAzureDevOpsTasks : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    ProviderTaskId = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ProviderTaskUrl = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    ...
                    AssignedToText = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CompletedByText = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    CreatedByText = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    DescriptionHtml = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CrystaTasks_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CrystaTasks_CreatedByUserId",
                schema: "CrystaLearn",
                table: "CrystaTasks",
