...
namespace CrystaLearn.Core.Migrations
{
    ...
    [Migration("20251226123528_AddDisplayCodeToCrytaDocument")]
    partial class AddDisplayCodeToCrytaDocument
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrystaLearn.Core.Models.Crysta.CrystaDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("CrystaDocument", "CrystaLearn");
                });
            ...
            modelBuilder.Entity("CrystaLearn.Core.Models.Crysta.CrystaDocument", b =>
                {
                    ...
                    b.OwnsOne("CrystaLearn.Core.Models.Crysta.SyncInfo", "SyncInfo", b1 =>
                        {
                            b1.Property<Guid>("CrystaDocumentId")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid")
                                .HasDefaultValueSql("gen_random_uuid()");
                            ...
                            b1.HasKey("CrystaDocumentId");

                            b1.HasIndex("SyncId")
                                .IsUnique();

                            b1.ToTable("CrystaDocument", "CrystaLearn");

                            b1.WithOwner()
                                .HasForeignKey("CrystaDocumentId");
                        });
